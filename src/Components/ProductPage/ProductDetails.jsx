...
function ProductDetails() {
  let { id } = useParams();
  let { getSingleProductDetails, singleProduct, singleProductLoading,handleCartUpdate } =
        ...
        <div className="product_details_mother_container">
          <div className="product_details_image_cont ">
            <div className="product_image_container">
              <img src={product_image} alt="loading.." className="  animate__animated animate__fadeInUp" />
            </div>
            <div className="product_details_container  animate__animated animate__fadeIn animate__delay-1s">
              ...
              <div className="cart_like_btn_div">
                <Button
                onClick={()=>{handleCartUpdate(singleProduct);notification()}}
                  mb="10px"
                  h={{ base: "36px", md: "42px" }}
                  w={{ base: "90%", md: " 80%" }}
                  colorScheme={"blue"}
